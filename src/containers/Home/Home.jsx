...
function Home() {
  return (
    ...
    >
      <Social />
      <div className="basis-full md:basis-2/3 order-2 md:order-1">
        <h1 className="text-peach-900 text-2xl font-bold subpixel-antialiased">
          Melody Le
        </h1>
        ...
        <p className="leading-relax pb-3">
          ...
          responsibility toward with high demand quality products, I am eager to
          utilize my tech skills and design skills to create impactful
          technology products.
        </p>
        <a
      ...
      <div className="profile-animation hover:scale-125 transition duration-150 ease-in-out w-9 basis-1/2 md:basis-1/5 justify-self-start order-1 md:order-2 max-w-20 aspect-square md:shrink-0 bg-cover bg-no-repeat bg-center bg-profile"></div>
    </div>
  );
}
