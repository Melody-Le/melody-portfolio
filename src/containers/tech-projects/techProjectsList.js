export const techProjects = [
  ...
  },
  {
    ...
    description: `With a mindset of constantly exploring new ideas and technologies, my team ( group of 3 developers) decided to build a community for developers to publish their products, find contributors to make amazing things happen. 
      ◦	Implement code review & PR commits across the team
      ◦	Practice project management tool with Zen hub
      ◦	Quickly catch up on new knowledge from MUI, React
      `,
  },
  {
    projectName: "Mikea",
